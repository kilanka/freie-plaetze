...
export type InstitutionGenderTypeNullableFilter = {
	...
	in?: Maybe<InstitutionGenderType[]>;
	not?: Maybe<InstitutionGenderTypeNullableFilter>;
	notIn?: Maybe<InstitutionGenderType[]>;
};
...
export type InstitutionRelateToManyForCreateInput = {
	connect?: Maybe<InstitutionWhereUniqueInput[]>;
	create?: Maybe<InstitutionCreateInput[]>;
};

export type InstitutionRelateToManyForUpdateInput = {
	connect?: Maybe<InstitutionWhereUniqueInput[]>;
	create?: Maybe<InstitutionCreateInput[]>;
	disconnect?: Maybe<InstitutionWhereUniqueInput[]>;
	set?: Maybe<InstitutionWhereUniqueInput[]>;
};
...
export type InstitutionWhereInput = {
	AND?: Maybe<InstitutionWhereInput[]>;
	NOT?: Maybe<InstitutionWhereInput[]>;
	OR?: Maybe<InstitutionWhereInput[]>;
...
export type NearbyInstitutionsQuery = {
	__typename?: "Query";
	nearbyInstitutions: Array<{
		...
		placesTotal: number;
		lastUpdated: any;
		photo?: {__typename?: "LocalImageFieldOutput"; src: string} | null | undefined;
	}>;
};
...
export type InstitutionsQuery = {
	__typename?: "Query";
	institutionsCount?: number | null | undefined;
	institutions?:
		| Array<{
				__typename?: "Institution";
				id: string;
 ...
 * });
 */
export function useNearbyInstitutionsQuery(
	baseOptions: Apollo.QueryHookOptions<NearbyInstitutionsQuery, NearbyInstitutionsQueryVariables>
) {
	const options = {...defaultOptions, ...baseOptions};
	return Apollo.useQuery<NearbyInstitutionsQuery, NearbyInstitutionsQueryVariables>(
		NearbyInstitutionsDocument,
		options
	);
}

export function useNearbyInstitutionsLazyQuery(
	baseOptions?: Apollo.LazyQueryHookOptions<
		NearbyInstitutionsQuery,
		NearbyInstitutionsQueryVariables
	>
) {
	const options = {...defaultOptions, ...baseOptions};
	return Apollo.useLazyQuery<NearbyInstitutionsQuery, NearbyInstitutionsQueryVariables>(
		NearbyInstitutionsDocument,
		options
	);
}
...
export type NearbyInstitutionsLazyQueryHookResult = ReturnType<
	typeof useNearbyInstitutionsLazyQuery
>;
export type NearbyInstitutionsQueryResult = Apollo.QueryResult<
	NearbyInstitutionsQuery,
	NearbyInstitutionsQueryVariables
>;
